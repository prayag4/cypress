...
class RandomUtility {
     ...
     generateRandomNumberss(min, max) {
    ...
    //Above function will be used in below function
     generateRandomTime() {
        const hour =  this.generateRandomNumber(0, 12);  // Use 12-hour format (0-12)
        const minute =  this.generateRandomNumber(0, 59);  // Minute range should be 0-59
     ...
     generateRandomTimeRange() {
        // Generate a random start hour and minute
        const startHour =  this.generateRandomNumber(0, 12); // 0-12 for 12-hour format
        const startMinute =  this.generateRandomNumber(0, 59); // 0-59 for minutes
        ...
        const durationInMinutes =  this.generateRandomNumber(15, 180);
     ...
     generateMultipleLineContent(lines = 1) {
        let content = '';
     ...
     getRandomSelectedValuesFromArray(array) {
     ...
     getRandomSelectedOneValueFromArray(array) {
        let randomIndex = Math.floor(Math.random() * array.length)
     ...
     getRandomDate() {
        ...
        const dateDDMMYYYformat =  this.formatDateToDDMMYYYY(randomDate)
...
// ( () => {
//     console.log( random.generateFakePhoneNumber("IN"))
// })()
